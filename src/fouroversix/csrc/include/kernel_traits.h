...
struct Base_kernel_traits {
    ...
    static constexpr float E4M3_MIN_POSITIVE_VALUE = 0.009765625;
...
struct FP4_quant_kernel_traits : public Base {
    ...
    static constexpr float E4M3_MIN_POSITIVE_VALUE = Base::E4M3_MIN_POSITIVE_VALUE;
    ...
    using SmemLayoutXTransposed = decltype(
        composition(SmemLayoutX{}, make_layout(Shape<Int<kBlockN>, Int<kBlockM>>{}, GenRowMajor{})));
    ...
    using GmemTiledCopyX = decltype(
        make_tiled_copy(Gmem_copy_atom_x{},
                        GmemLayoutAtomX{},
                        Layout<Shape<_1, _8>>{}));
    ...
    using GmemTiledCopySFT = decltype(
        make_tiled_copy(Gmem_copy_atom_sft{}, GmemLayoutAtomSFT{}, Layout<Shape<_1, _4>>{}));
